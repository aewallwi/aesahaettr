...
def cov_mat_simple(uvd, antenna_chromaticity=0.0, bl_cutoff=np.inf, order_by_bl_length=False):
    """
    ...
    bl_cutoff_buffer: float, optional
        ...
        thus the larger the bl_cutoff_buffer, the fewer off-diag terms are set to zero.
