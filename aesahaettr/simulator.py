...
def run_simulation(gorder=10, dx=2.0, df=100e3, nf=200, rspace=1., dynamic_range_db=-5.5, f0=100e6, output_dir='./', NSIDE_GSM=256):
...
def generate_grid_params(r_spaces=None, dxs=None, nfs=None, gorders=None, dfs=None):
